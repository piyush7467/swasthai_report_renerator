...
public class TestParameter {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "input_type", nullable = false, length = 20, columnDefinition = "varchar(20) not null default 'MANUAL'")
    @Builder.Default
    private ParameterInputType inputType = ParameterInputType.MANUAL;

    @Enumerated(EnumType.STRING)
    @Column(name = "calculation_type", nullable = false, length = 50, columnDefinition = "varchar(50) not null default 'NONE'")
    @Builder.Default
